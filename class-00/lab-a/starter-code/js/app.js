...
function displayPics(){
  ...
  // console.log(rando); threw an error since rando was declared with const instead of var.
  // Since const is block scoped, rando is not acessisable outside of the function where it was declared with const.
  console.log(viewed);
